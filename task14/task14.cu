// CUDA SAXPY
// SAXPY означает «Single-Precision A * X Plus Y». 
// SAXPY – это комбинация скалярного умножения и сложения векторов, 
